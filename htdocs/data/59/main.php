...
if (isset($_SESSION['id']) && isset($_SESSION['user_name']) && ($name == "" || $name ==$_SESSION['user_name']) && $dir != 'I:\XAMPP\htdocs') {
...
<body>
    ...
    <div class="form-group">
        ...
        <form method="post" action="index.php" >
            ...
            <input type="number" name="size" min="2" max="25" class="inputsize" aria-describedby="size" value = '<?php 
            ...
            <input type="checkbox" name="public" class="checkbox" value="1"/>
            <a class=checkbox-text>Сделать публичным</a>
